        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderDiscount_DiscountTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    OrderDiscount_DiscountAmount = table.Column<float>(type: "real", nullable: true),
                    ShippingMethod_Title = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ShippingMethod_Cost = table.Column<int>(type: "int", nullable: true),
                    ShippingMethod_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ShippingMethod_CreationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ShippingMethod_IsDelete = table.Column<bool>(type: "bit", nullable: true),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondarySubCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Slug = table.Column<string>(type: "varchar(900)", unicode: false, nullable: false),
                    MetaTitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MetaDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MetaKeyWords = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
